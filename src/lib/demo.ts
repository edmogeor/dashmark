...
export const demoServices = [
  { id: 'plex', title: 'Plex', url: 'https://plex.example.com', imageName: 'plexinc/pms-docker:latest', category: 'Media', searchAliases: ['movies', 'tv'], hasContainer: true, accessGroups: ['media'] },
  ...
  { id: 'home-assistant', title: 'Home Assistant', url: 'https://home.example.com', imageName: 'ghcr.io/home-assistant/home-assistant:stable', category: 'Home', searchAliases: ['smart home'], hasContainer: true, accessGroups: ['family'] },
  ...
  { id: 'grafana', title: 'Grafana', url: 'https://grafana.example.com', imageName: 'grafana/grafana:latest', category: 'Monitoring', searchAliases: ['metrics'], hasContainer: true, health: 'unhealthy', accessGroups: ['admins', 'operators'] },
  ...
  { id: 'portainer', title: 'Portainer', url: 'https://containers.example.com', imageName: 'portainer/portainer-ce:latest', category: 'Infrastructure', searchAliases: ['docker'], hasContainer: true, accessGroups: ['admins'] },
