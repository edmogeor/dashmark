...
const demoServiceDefinitions = [
  {
    ...
    category: 'Media',
    searchAliases: ['movies', 'tv'],
    hasContainer: true,
    access: ['media'],
    resourceStats: ['cpu', 'memory', 'network'],
    metrics: ['gatus/uptime'],
    resourceUsage: {
      cpuPercent: 24.6,
  ...
  { id: 'nextcloud', title: 'Nextcloud', url: 'https://cloud.example.com', imageName: 'nextcloud:latest', category: 'Productivity', searchAliases: ['files', 'calendar'], hasContainer: true },
  {
    ...
    searchAliases: ['documents', 'archive'],
    hasContainer: true
  },
  ...
  },
  {
    ...
    imageName: 'louislam/uptime-kuma:latest',
    category: 'Monitoring',
    searchAliases: ['status'],
    hasContainer: true,
    health: 'starting'
  },
  {
