...
| gatus | uptime | Uptime | group (Gatus group), name (Gatus endpoint name) | None | Dashmark polls the newest 100 Gatus history results. Use persistent SQLite or Postgres storage and increase storage.maximum-number-of-results to retain the uptime history you want Dashmark to display. |
