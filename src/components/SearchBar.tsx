  ...
  return (
    <div className="dashmark-search relative">
      ...
      <Input
        ...
        className="dashmark-search-input border-0 bg-muted pl-10 pr-10 text-sm focus-visible:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-card sm:text-[0.9375rem] md:text-[0.9375rem] lg:text-base"
      />
      {value && (
        <button
          type="button"
