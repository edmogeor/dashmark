...
function validate(file) {
  ...
  if (valueType === 'number') {
    ...
    const validUnit = typeof unit === 'string' ? units.has(unit) : unit !== null && typeof unit === 'object'
      && !Array.isArray(unit) && Object.keys(unit).length === 1 && typeof unit.suffix === 'string' && Boolean(unit.suffix)
